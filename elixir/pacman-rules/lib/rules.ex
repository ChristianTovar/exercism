defmodule Rules do
  ...
  def eat_ghost?(_power_pellet, _touching_ghost), do: false
  ...
  def win?(true, _power_pellet_active, false), do: true
  def win?(_all_dots_eaten, _power_pellet_active, _touching_ghost), do: false
end
